...
import { FaGithub, FaLinkedin, FaInstagram, FaTelegramPlane, FaTwitter} from "react-icons/fa";
...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: FaLinkedin,
    url: "https://www.linkedin.com/in/prathiksha-a-b553b0229/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@prathi.birwa",
    icon: FaInstagram,
    url: "https://www.instagram.com/prathi.birwa",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@prathiksha3",
    icon: FaGithub,
    url: "https://github.com/prathiksha3",
    color: "#ffffff",
