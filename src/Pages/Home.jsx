...
const TECH_STACK = ["Python", "NextJS", "Node.js", "Javascript","Java"];
const SOCIAL_LINKS = [
  { icon: FaGithub, link: "https://github.com/prathiksha3" },
  { icon: FaLinkedin, link: "https://www.linkedin.com/in/prathiksha-a-b553b0229/" },
  { icon: FaInstagram, link: "https://www.instagram.com/prathi.birwa" }
];
      ...
      <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
        <div className="container mx-auto px-[5%] sm:px-6 lg:px-[0%] min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            {/* Left Column */}
            <div className="w-full ml-4 pl-4 lg:ml-28 lg:pl-10 lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              data-aos="fade-right"
              data-aos-delay="200">
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Web Developer | Building Functional & Engaging Digital Experiences
                </p>
